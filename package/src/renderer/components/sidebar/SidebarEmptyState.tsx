...
export const SidebarEmptyState = () => {
  ...
  const workspaceList = useVibecapeStore((state) => state.workspaceList);
  const listLoading = useVibecapeStore((state) => state.listLoading);
  const createWorkspace = useVibecapeStore((state) => state.createWorkspace);
  const openWorkspace = useVibecapeStore((state) => state.openWorkspace);
  const deleteWorkspace = useVibecapeStore((state) => state.deleteWorkspace);

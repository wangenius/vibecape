...
import "./handler/novel/Novelhandler";
import "./handler/novel/NovelAIHandler";
import "./handler/cosmos/MetaHandler";
import "./handler/cosmos/StoryHandler";
import "./handler/cosmos/ActantHandler";
import "./handler/cosmos/LoreHandler";
import "./handler/cosmos/ActantStateHandler";
import "./handler/cosmos/LoreTypeHandler";
import "./handler/cosmos/ActantTypeHandler";
import "./handler/cosmos/RelationHandler";
...
app.whenReady().then(async () => {
  ...
  // 初始化项目管理器
  const { cosmosManager } = await import("./utils/CosmosManager");
  await cosmosManager.init();

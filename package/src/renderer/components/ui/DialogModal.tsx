        ...
        {isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <motion.div
              ...
              className={cn(
                "relative z-50 max-h-[85vh] max-w-[80vw] rounded-4xl [corner-shape:squircle] bg-background p-6 pt-3 shadow-lg w-[800px] flex flex-col gap-4 border border-border",
                className,

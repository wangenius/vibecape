          ...
          <Tooltip delayDuration={400}>
            ...
            <TooltipContent>
              <div className="text-muted-foreground text-xs">
                <h4 className="max-w-60 overflow-hidden whitespace-normal wrap-break-words text-left font-semibold text-sm">
                  {data.filename || "Unknown file"}
                </h4>
    ...
    Promise.all(
      ...
      try {
        ...
        if (result instanceof Promise) {
          ...
          // Sync function completed without throwing, clear attachments and form
          clear();
          if (usingProvider) {
            controller.textInput.clear();
          } else {
